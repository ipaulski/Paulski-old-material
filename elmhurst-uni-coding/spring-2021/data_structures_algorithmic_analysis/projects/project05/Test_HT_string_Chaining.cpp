...
//****************Testing HashTable<string> with Chaining probing ***************
{
	...
	//Test Chaining Probing with vector of HashTableChaining<string>
	cout << "****Starting analysis of HashTable<string> using Chaining Probing****" << endl;
	htAnalysisFile << "****Starting analysis of HashTable<string> using Chaining Probing****" << endl;
	...
	htAnalysisFile << "HT<string> Chaining Probing Initial Insertion of strings:\n";
	...
	htAnalysisFile << "HT<string> Chaining probing Successful 'Contains' Probes Totals:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << endl;
	htAnalysisFile << "HT<string> Chaining probing Average Successful 'Contains': \n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << resultSuccessContainsTotalProbes[i] / static_cast<double>(successfulTotal[i]) << "\t";
	}
	htAnalysisFile << endl;
	htAnalysisFile << "HT<string> Chaining probing  Unsuccessful 'Contains' Probe Totals: \n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << endl;
	htAnalysisFile << "HT<string> Chaining probing Average Unsuccessful Contains: \n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << resultUnSuccessContainsTotalProbes[i] / static_cast<double>(unsuccessfulTotal[i]) << "\t";
	}
	htAnalysisFile << endl;
	htAnalysisFile << "****Finished analysis of HashTable<string> using Chaining probing****" << endl;
	cout << "****Finished analysis of HashTable<string> using Chaining probing****" << endl;
	htAnalysisFile << endl;
}
