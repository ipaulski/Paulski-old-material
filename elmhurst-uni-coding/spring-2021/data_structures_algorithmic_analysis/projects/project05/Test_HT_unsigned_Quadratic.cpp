...
void test_HT_unsigned_quadratic(
...
////***********************************Quadratic Probing using unsigned keys***********************
{
	...
	vector<HashTableQuad<unsigned>> hl{
		HashTableQuad<unsigned>(),				 //Not used.
		HashTableQuad<unsigned>(TABLE_SIZE_1),  //MAX_NUM_KEYS/.1 gets first prime greater than TABLE_SIZE_LF10
		HashTableQuad<unsigned>(TABLE_SIZE_2),  //MAX_NUM_KEYS/.2
		HashTableQuad<unsigned>(TABLE_SIZE_3),  //MAX_NUM_KEYS/.3
		HashTableQuad<unsigned>(TABLE_SIZE_4),  //MAX_NUM_KEYS/.4
		HashTableQuad<unsigned>(TABLE_SIZE_5),   //MAX_NUM_KEYS/.5
		HashTableQuad<unsigned>(TABLE_SIZE_6),  //MAX_NUM_KEYS/.6
		HashTableQuad<unsigned>(TABLE_SIZE_7),  //MAX_NUM_KEYS/.7
		HashTableQuad<unsigned>(TABLE_SIZE_8),  //MAX_NUM_KEYS/.8
		HashTableQuad<unsigned>(TABLE_SIZE_9)   //MAX_NUM_KEYS/.9
	};


	////Test Linear Probing with vector of HashTableLinear<unsigned>
	cout << "****Starting analysis of HashTable<unsigned> using Quadratic Probing ****" << endl;
	htAnalysisFile << "****Starting analysis of HashTable<unsigned> using Quadratic Probing ****" << endl;
	unsigned tableNum;
	...
	htAnalysisFile << "Quadratic Probing Initial Insertion Results:\n";
	...
	htAnalysisFile << "Quadratic Probing Successful Contains Results:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << "Quadratic Probing Unsuccessful Contains Results:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << endl;
	cout << "****Finished analysis of HashTable<unsigned> using Quadratic Probing ****" << endl;
	htAnalysisFile << "****Finished analysis of HashTable<unsigned> using Quadratic Probing ****" << endl;
	htAnalysisFile << endl;
}