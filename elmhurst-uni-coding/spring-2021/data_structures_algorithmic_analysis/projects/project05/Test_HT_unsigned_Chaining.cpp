...
//****************Testing HashTable with Chaining using unsigned keys*****************
{
	...
	vector<HashTableChaining<unsigned>> hl{
		HashTableChaining<unsigned>(),				 //Not used.
		HashTableChaining<unsigned>(TABLE_SIZE_1),  //MAX_NUM_KEYS/.1 gets first prime greater than TABLE_SIZE_LF10
		HashTableChaining<unsigned>(TABLE_SIZE_2),  //MAX_NUM_KEYS/.2
		HashTableChaining<unsigned>(TABLE_SIZE_3),  //MAX_NUM_KEYS/.3
		HashTableChaining<unsigned>(TABLE_SIZE_4),  //MAX_NUM_KEYS/.4
		HashTableChaining<unsigned>(TABLE_SIZE_5),   //MAX_NUM_KEYS/.5
		HashTableChaining<unsigned>(TABLE_SIZE_6),  //MAX_NUM_KEYS/.6
		HashTableChaining<unsigned>(TABLE_SIZE_7),  //MAX_NUM_KEYS/.7
		HashTableChaining<unsigned>(TABLE_SIZE_8),  //MAX_NUM_KEYS/.8
		HashTableChaining<unsigned>(TABLE_SIZE_9)   //MAX_NUM_KEYS/.9
	};


	////Test Linear Probing with vector of HashTableLinear<unsigned>
	cout << "****Starting analysis of HashTable<unsigned> using Separate Chaining ****" << endl;
	htAnalysisFile << "****Starting analysis of HashTable<unsigned> using Separate Chaining ****" << endl;
	unsigned tableNum;
	...
	htAnalysisFile << "Separate Chaining Initial Insertion Results:\n";
	...
	htAnalysisFile << "Separate Chaining Successful Contains Results:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << "Separate Chaining Unsuccessful Contains Results:\n";
	for (unsigned i = 1; i < NUM_OF_TABLES; i++) {
		htAnalysisFile << i << "\t\t";
	}
	htAnalysisFile << endl;
	...
	htAnalysisFile << endl;
	cout << "****Finished analysis of HashTable<unsigned> using Separate Chaining ****" << endl;
	htAnalysisFile << "****Finished analysis of HashTable<unsigned> using Separate Chaining ****" << endl;
	htAnalysisFile << endl;
}